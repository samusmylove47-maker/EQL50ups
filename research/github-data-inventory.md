...
- ~30% of wiki item pages carry **no era category at all**; unresolvable items are left **visible** deliberately, since hiding ~1,276 rows on a missing category is the worse failure.
